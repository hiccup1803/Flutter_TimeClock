...
class AdminCalendarFilterWidget extends StatefulWidget {
  AdminCalendarFilterWidget({required this.filterValue, Key? key}) : super(key: key);
...
class _AdminCalendarFilterWidgetState extends State<AdminCalendarFilterWidget> {
  bool showTask = true;
                ...
                FlutterSwitch(
                  ...
                  onToggle: (val) {
                    ...
                    BlocProvider.of<CalendarsCubit>(context)
                        .updateFilter([showTask, showSession, showOffTime], assignee: _profileId);
                  },
                ),
                SizedBox(
                  width: 5,
              ...
              child: ElevatedButton(
                ...
                onPressed: _enable
                    ? () {
                        ...
                        BlocProvider.of<CalendarsCubit>(context).updateFilter(
                            [showTask, showSession, showOffTime],
                            assignee: _profileId).then((v) {
                          if (v == true) {
                            setState(() {
                              isLoading = false;
                              Navigator.of(context).pop();
